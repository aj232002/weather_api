...
const getWeatherData = async(location) => {
    ...
    const api_key = 'c31691ad7c972fbb33b0ae9f3cc4e356';
    const response = await fetch(`https://api.openweathermap.org/data/3.0/onecall/timemachine?lat={lat}&lon={lon}&dt={time}&appid={API key}`);
